...
{
    public class RenewInvestorDetailsSaveDAL
    {
        private readonly string conn;
        private readonly IConfiguration configuration;
        public RenewInvestorDetailsSaveDAL(IConfiguration configuration)
        {
            try
            {
        ...
        //        sqlparam[29] = new SqlParameter("@Source", "CPTP_UNI_RW");
        ...
        //        return SqlHelper.ExecuteDataTable(conn, CommandType.StoredProcedure, "USP_FD_BT_UNI_RW_RENEW_COPY_INSERT_FRONT_OFFICE_DTL", sqlparam);
        //    }
        //    catch (Exception ex)
        //    {
        //        throw ex;
        ...
        //step1 save for copy
        public DataTable Renew_Front_Office_Dtls(FrontOfficeRenewSaveBO saveBO, SessionBO session)
        {
            try
            {
                ...
                return SqlHelper.ExecuteDataTable(conn, CommandType.StoredProcedure, "USP_FD_BT_UNI_RW_RENEW_FRONT_OFFICE_DTL", sqlparam);
        ...
        public bool Insert_Other_Dtls(Investor_Other_DtlBO investor_Other_Dtl, SessionBO session)
        {
            try
            {
                ...
                sqlparam[16] = new SqlParameter("@Source", "CPTP_UNI_RW");
                ...
                cnt = SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "USP_FD_BT_UNI_RW_RENEW_INSERT_OTHER_Dtl", sqlparam);
        ...
        //step3 save
        public bool Insert_Investment_Dtls(RenewalInvestment_DtlBO objBO, SessionBO session)
        {
            try
            {
                int cnt = 0;
                ...
                sqlparam[42] = new SqlParameter("@FutureRenewalFor", string.IsNullOrEmpty(objBO.FutureRenewalFor) ? (object)DBNull.Value : objBO.FutureRenewalFor);

                cnt = SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "USP_FD_BT_UNI_RW_RENEW_INSERT_INVESTMENT_DTLS", sqlparam);
                return cnt > 0 ? true : false;
            }
            catch (Exception ex)
            {
        ...
        public bool Insert_Repayment_Bank_Dtls(Investor_Bank_DtlBO objBO, SessionBO session)
        {
            try
            {
                ...
                sqlparam[10] = new SqlParameter("@Source", "CPTP_UNI_RW");
                ...
                cnt = SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "USP_FD_BT_UNI_RW_RENEW_INSERT_REPAYMENT_BANK_DTLS", sqlparam);
        ...
        public bool Insert_Nominee_Details(Nominee_Dtl nominee_Dtl, SessionBO session)
        {
            try
            {
                ...
                sqlparam[32] = new SqlParameter("@Source", "CPTP_UNI_RW");
                ...
                cnt = SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "USP_FD_BT_UNI_RW_RENEW_INSERT_NOMINEE_DTLS", sqlparam);
                return cnt > 0 ? true : false;
            }
            catch (Exception)
            {
        ...
        public bool Insert_OVD(List<OVDBO> _OVD, SessionBO session)
        {
            ...
            try
            {
                ...
                cnt = SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "USP_FD_BT_UNI_RW_RENEW_INSERT_OVD_REF", sqlparam);
                return cnt > 0 ? true : false;
            }
            catch (Exception)
            {
        ...
        public bool UpdateApplicationDetails(UpdateApplicationBO updateApplication, SessionBO session)
        {
            try
            {
                ...
                sqlparam[8] = new SqlParameter("@Source", "CPTP_UNI_RW");

                cnt = SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "USP_FD_BT_UNI_RW_RENEW_UPDATE_APPL_STATUS", sqlparam);
                return cnt > 0 ? true : false;
            }
            catch (Exception)
            {
        ...
        //step8 save
        public bool Insert_Front_Office_Dtls_TRAN(FrontOfficeRenewSaveBO saveBO, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            try
            {
                SqlParameter[] sqlparam = new SqlParameter[54];
                ...
                {
                    Connection = sqlCon,
                    CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_FRONT_OFFICE_DTL",
        ...
        public bool Insert_Other_Dtls_TRAN(Investor_Other_DtlBO investor_Other_Dtl, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            try
            {
                ...
                {
                    Connection = sqlCon,
                    CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_OTHER_Dtl",
                    CommandType = CommandType.StoredProcedure
                };
                if (sqlTrans != null)
                    cmd.Transaction = sqlTrans;
        ...
        //step8 save
        public bool Insert_Investment_Dtls_TRAN(RenewalInvestment_DtlBO objBO, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            try
            {
                int cnt = 0;
                ...
                {
                    Connection = sqlCon,
                    CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_INVESTMENT_DTLS",
                    CommandType = CommandType.StoredProcedure
                };
                if (sqlTrans != null)
                    cmd.Transaction = sqlTrans;
        ...
        public bool Insert_Repayment_Bank_Dtls_TRAN(Investor_Bank_DtlBO objBO, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            try
            {
                ...
                {
                    Connection = sqlCon,
                    CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_REPAYMENT_BANK_DTLS",
                    CommandType = CommandType.StoredProcedure
                };
                if (sqlTrans != null)
                    cmd.Transaction = sqlTrans;
            ...
            try
            {
                ...
                foreach (var i in ObjKYCDataDetail)
                {
                    ...
                    SqlParameter[] Params1 ={
                     ...
                     new SqlParameter("@Source","CPTP_UNI_RW"),
                    ...
                    {
                        Connection = sqlCon,
                        //CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_KYC_DATA_DTLS_V1",
                        CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_KYC_DATA_DTLS_V2",
                        CommandType = CommandType.StoredProcedure
                    };
                    if (sqlTrans != null)
                        cmd.Transaction = sqlTrans;
        ...
        public bool Insert_Address_Details_TRAN(List<InvestorAddressBO> investorAddressBO, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            try
            {
                ...
                foreach (var i in investorAddressBO)
                {
                    ...
                    sqlparam[35] = new SqlParameter("@Source", "CPTP_UNI_RW");
                    ...
                    {
                        Connection = sqlCon,
                        CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_ADDRESS_DTLS",
                        CommandType = CommandType.StoredProcedure
                    };
                    if (sqlTrans != null)
                        cmd.Transaction = sqlTrans;
        ...
        public bool Insert_FATCA_DETAILS_TRAN(List<DataEntryBO> dataEntryBOs, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            try
            {
                ...
                foreach (var dataEntryBO in dataEntryBOs)
                {
                    ...
                    sqlparam[20] = new SqlParameter("@Source", "CPTP_UNI_RW");
                    ...
                    {
                        Connection = sqlCon,
                        CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_FATCA_DETAILS",
                        CommandType = CommandType.StoredProcedure
                    };
                    if (sqlTrans != null)
                        cmd.Transaction = sqlTrans;
        ...
        public bool Insert_Nominee_Details_TRAN(Nominee_Dtl nominee_Dtl, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            try
            {
                ...
                {
                    Connection = sqlCon,
                    CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_NOMINEE_DTLS",
                    CommandType = CommandType.StoredProcedure
                };
                if (sqlTrans != null)
                    cmd.Transaction = sqlTrans;
        ...
        public bool Insert_OVD_TRAN(List<OVDBO> _OVD, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            ...
            try
            {
                ...
                {
                    Connection = sqlCon,
                    CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_OVD_REF",
                    CommandType = CommandType.StoredProcedure
                };
                if (sqlTrans != null)
                    cmd.Transaction = sqlTrans;
        ...
        public bool Insert_Coparceners_Dtl_TRAN(List<Coparceners_DtlBO> MemberDtls, Investor_Other_DtlBO investor_Other_Dtl, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            ...
            try
            {
                ...
                sqlparam[4] = new SqlParameter("@CreatedIP", session.CreatedIP);
                sqlparam[5] = new SqlParameter("@SessionId", session.Session_ID);
                sqlparam[6] = new SqlParameter("@Source", "CPTP_UNI_RW");
                ...
                {
                    Connection = sqlCon,
                    CommandText = "USP_FD_BT_UNI_RW_RENEW_INSERT_COPARCENERS_Dtl",
                    CommandType = CommandType.StoredProcedure
                };
                if (sqlTrans != null)
                    cmd.Transaction = sqlTrans;
        ...
        //step8 save
        public bool UpdateApplicationDetails_TRAN(FrontOfficeRenewSaveBO frontOfficeSaveBO, string State, string Status, SessionBO session, SqlConnection sqlCon, SqlTransaction sqlTrans = null)
        {
            try
            {
                int cnt = 0;
                ...
                {
                    Connection = sqlCon,
                    CommandText = "USP_FD_BT_UNI_RW_UPDATE_APPL_STATUS_V1",
                    CommandType = CommandType.StoredProcedure,
                };
                if (sqlTrans != null)
                { 
