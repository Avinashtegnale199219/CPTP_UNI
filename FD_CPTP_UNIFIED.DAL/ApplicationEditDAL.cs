...
{
    public class ApplicationEditDAL
    {

        readonly string Conn = string.Empty;
        public ApplicationEditDAL(IConfiguration configuration)
        {
        ...
        public async Task<DataTable> GET_APPLS_FOR_EDITAsync(SessionBO session)
        {
            ...
            try
            {
                ...
                {
                    Connection = sqlConn,
                    CommandText = "USP_FD_BT_UNI_GET_APPL_LIST_FOR_EDIT_V1",
        ...
        public async Task<DataSet> GET_APPL_DTLS_FOR_EDITAsync(string Appl_No, SessionBO session)
        {
            ...
            try
            {
                ...
                {
                    Connection = sqlConn,
                    CommandText = "USP_FD_BT_UNI_GET_APPL_DTLS_FOR_EDIT",
                    CommandType = CommandType.StoredProcedure,
                };
